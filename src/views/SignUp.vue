            ...
            <v-form ref="form" v-model="form" class="pa-4 mt-6">
                ...
                <v-alert v-if="errorMsg" border="top" color="red" class="ml-5 mr-5">
                    ...
                    <v-card-actions>
                        ...
                        <v-spacer></v-spacer>
                        <v-btn :disabled="!form" color="primary" :loading="isLoading" depressed @click="signUpWithEmailAndPassword">Sign Up</v-btn>
                    </v-card-actions>
    </v-card>
...
export default {
    data: ()=>({
        ...
        isLoading: false ,
        rules:{
            email: (v) =>!!(v||'').match(/@/)|| 'Please enter a valid mail',
